...
import {
  KIWIFY_STEPS, PAYT_STEPS, HUBLA_STEPS, CAKTO_STEPS, API_FIELDS, EXAMPLE_PAYLOAD,
} from "./guideSteps";
      ...
      <PopoverContent align="end" className="w-[460px] p-0">
        <div className="max-h-[80vh] overflow-y-auto p-4 space-y-3">
          ...
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="hubla" className="border-border/50">
              <AccordionTrigger className="text-xs font-semibold py-2.5 hover:no-underline">
                <PlatformLogo platform="hubla" size="md" />
              </AccordionTrigger>
              <AccordionContent className="pb-3 pt-1">
                <StepsList steps={HUBLA_STEPS} />
              </AccordionContent>
            </AccordionItem>

            <AccordionItem value="cakto" className="border-border/50">
              <AccordionTrigger className="text-xs font-semibold py-2.5 hover:no-underline">
                <PlatformLogo platform="cakto" size="md" />
              </AccordionTrigger>
              <AccordionContent className="pb-3 pt-1">
                <StepsList steps={CAKTO_STEPS} />
              </AccordionContent>
            </AccordionItem>
