...
const tool = {
    ...
    description: "Returns a full dashboard overview for the given period: KPIs (revenue, sales, ROI, ROAS, refund rate), " +
...
export default tool;
//# sourceMappingURL=get_dashboard_overview.js.map