...
const tool = {
    name: "run_db_query",
    description: "Executes a read-only (SELECT) SQL query against the Log Pose PostgreSQL database and returns results. " +
    ...
    inputSchema: z.object({
        sql: z
            .string()
            .describe("A valid PostgreSQL SELECT statement. " +
...
export default tool;
//# sourceMappingURL=run_db_query.js.map